          ...
          <motion.div variants={itemVariants}>
            <Link to="/" className="flex items-center space-x-3 group">
              ...
              <div>
                ...
                <motion.p
                  className="text-sm text-gray-600 group-hover:text-gray-500 transition-colors duration-300"
                  whileHover={{ x: 2 }}
                >
              ...
              <motion.div variants={buttonVariants}>
                ...
                >
                  <Button
                    ...
                    className="border-gray-300 text-gray-700 hover:bg-red-50 hover:border-red-300 hover:text-red-600 transition-all duration-300 group"
                  >
                    <LogOut className="w-4 h-4 mr-2 group-hover:text-red-600 transition-colors duration-300" />
